...
|---|---|---|---|
| [**brokkr**](https://github.com/feedback-loop-ai/brokkr) | **Engine.** Deterministic delivery engine for autonomous multi-agent software delivery. An event-sourced phase machine is the outermost layer; agent sessions are leaf effects inside it. Runs you can replay, releases you can prove. | MIT OR Apache-2.0 | [v0.10.0](https://github.com/feedback-loop-ai/brokkr/releases/tag/v0.10.0) · Rust |
